...
% %% varying current
label = {['trial # ' num2str(trial_num(1)) ' stim with ' freq{1} ' Hz'], ['trial # ' num2str(trial_num(2)) ' stim with ' freq{2} ' Hz']};
title_txt = sprintf('at %s \\muA in %s ms at %s', cur, duration, region);
coloring = {'b', 'r'};
fig = figure;
tiledlayout(5,1)
nexttile;
