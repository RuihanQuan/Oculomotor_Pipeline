...
function [output, timeframe] = extract_segments_with_neural(sample, params)
    ...
    fr_untrimmed = cell(n,1);
    ua_untrimmed = cell(n,1);
    ...
    for i = 1:n
        ...
        fr_untrimmed{i} = fr(start_idx-prebuffer:end_idx+postbuffer);
        ua_untrimmed{i} = ua(start_idx-prebuffer:end_idx+postbuffer);
    ...
    output.fr = trim_cell_data(fr_untrimmed);
    output.ua = trim_cell_data(ua_untrimmed);
