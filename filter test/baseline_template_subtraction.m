...
switch flag
    case 1
        ...
        for i = 1:128
            ...
            mean_template = mean(chn_pulse(temp, 1:period_avg+prebuffer), 1);
    ...
    case 3
        ...
        artifact_ICA = extract_artifact_ICA(chn_pulse_data, 4, 16, 'ImecPrimateStimRec128_042421.mat');
    ...
    otherwise
        ...
        average_across_chan = artifact_PCA;
end
